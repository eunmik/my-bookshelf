...
public class DayAndMonthRule extends AnnualDateRule {
     ...
     * <P>
     * For the month parameter, use DayDate.JANUARY, etc. Note that there
     ...
     * @param month  the month (use DayDate.JANUARY, DayDate.FEBRUARY etc.);
     */
    ...
    public void setDayOfMonth(final int dayOfMonth) {
        ...
        // check arguments...
        if ((dayOfMonth < 1) || (dayOfMonth > Month.fromInt(this.month).toInt())) {
     ...
     * SEPTEMBER, OCTOBER, NOVEMBER and DECEMBER are defined in the DayDate
     * class.
     *
